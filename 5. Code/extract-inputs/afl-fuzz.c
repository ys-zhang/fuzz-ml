...
EXP_ST u8 common_fuzz_stuff(char** argv, u8* out_buf, u32 len) {
  ...
  // ===================== store the input ========================
  memcpy(zys_bitmap, trace_bits, MAP_SIZE);
  zys_store(out_buf, len, zys_bitmap);
  // ===================== done with input store ==================
...
int main(int argc, char** argv) {
  ...
  // ===================== setup go-store connection =========================
  zys_setup_sock();
  // ===================== done with go-store setup ==========================
...
stop_fuzzing:
  ...
  // ====================== close go-store connection ======================
  zys_close_sock();
  // ====================== done with go-store conn close ==================
